...
import 'package:image_fetcher/features/image_fetcher/presentation/widget/permission__handler_widget.dart';
import 'package:image_fetcher/features/gallery/presentation/pages/all_photos_view.dart';
      ...
      body: BlocConsumer<ImageFetcherCubit, ImageFetcherState>(
        ...
        switch (state) {
          case ImageFetcherLoadingState():
            return const CommonCircularLoader(
